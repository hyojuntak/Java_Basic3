...
/**
 * 
 * draw매서드는 도형을 그리기 위한 추상매서드이다.
 * share 클래스에서 파생되는 클래스에서 이 매서드를 구현한다.
 */
    public abstract void draw();


/**
 * print 매서드는 도형 정보의 정보를 표시하고 도형 자체를 그린
 * 구체적으로 다음 두 단계를 따른다.
...
public abstract class AbstLine extends Shape {
    ...
    */
     ...
     */
     ...
     /**
      * 직선의 길이를 설정한다.
      * @param length 설정한 직선의 길이
      */
      public void setLength(int lengh){
          this.length = lengh;

      }

      /**
       * toString 매서드는 직전에 관련된 도형 정보를 문자열로 반환한다.
